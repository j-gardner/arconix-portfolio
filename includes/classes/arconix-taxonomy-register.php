...
class Arconix_Taxonomy_Register {
	...
	protected function set_labels() {
		...
		$labels = array( 'labels' => array (
			'name'                  => sprintf( __( '%s', 'arconix-portfolio' ), $plural ),
			'singular_name'         => sprintf( __( '%s', 'arconix-portfolio' ), $singular ),
			'menu_name'             => sprintf( __( '%s', 'arconix-portfolio' ), $plural ),
			'all_items'             => sprintf( __( '%s', 'arconix-portfolio' ), $plural ),
			'add_new'               => __( 'Add New', 'arconix-portfolio' ),
			'add_new_item'          => sprintf( __( 'Add New %s', 'arconix-portfolio' ), $singular ),
			'edit_item'             => sprintf( __( 'Edit %s', 'arconix-portfolio' ), $singular ),
			'new_item'              => sprintf( __( 'New %s', 'arconix-portfolio' ), $singular ),
			'view_item'             => sprintf( __( 'View %s', 'arconix-portfolio' ), $singular ),
			'search_items'          => sprintf( __( 'Search %s', 'arconix-portfolio' ), $plural ),
			'not_found'             => sprintf( __( 'No %s found', 'arconix-portfolio' ), $plural ),
			'not_found_in_trash'	=> sprintf( __( 'No %s found in Trash', 'arconix-portfolio' ), $plural ),
			'parent_item_colon'     => sprintf( __( 'Parent %s:', 'arconix-portfolio' ), $singular ),
            'parent_item'           => sprintf( __( 'Parent %s', 'arconix-portfolio' ), $singular ),
		) );
